const videos = [
  ...
  { sku: 'CF127',	name: 'Party Popper', group: 'novelty', hasVideo: false, price: '' },
  ...
  { sku: 'FN127',	name: 'America Forever', group: 'fountain', hasVideo: false, price: '' },
  ...
  { sku: 'FN475',	name: 'Neon Nights', group: 'fountain', hasVideo: false, price: '' },
  { sku: 'FN480',	name: 'Sawworks', group: 'fountain', hasVideo: false, price: '' },
  { sku: 'FR280',	name: 'Cherry Bomb Firecrackers 16s', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'FR285',	name: 'Cherry Bomb Firecrackers 200s', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'FR286',	name: 'Cherry Bomb Firecrackers 1,000s', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'FS304',	name: 'IGNITE Lite Electronic Ignition System', group: 'systems', hasVideo: false, price: '' },
  ...
  { sku: 'GM152',	name: 'Shock the Monkey', group: 'multi', hasVideo: false, price: '' },
  ...
  { sku: 'GM750',	name: 'Monster Bucks', group: 'multi', hasVideo: false, price: '' },
  { sku: 'GM751',	name: 'Whistling Wings', group: 'multi', hasVideo: true, price: '' },
  { sku: 'GM866',	name: 'Bull Market', group: 'multi', hasVideo: true, price: '' },
  { sku: 'GM891',	name: 'Highway Robbery', group: 'multi', hasVideo: false, price: '' },
  ...
  { sku: 'ME101',	name: 'X-Wing Missile - 6"', group: 'rocket', hasVideo: false, price: '' },
  { sku: 'MS108',	name: 'Twitter Glitter', group: 'multi', hasVideo: false, price: '' },
  { sku: 'MS113',	name: 'Garden in Spring', group: 'multi', hasVideo: true, price: '' },
  { sku: 'MS121',	name: 'Color Pearl 96s', group: 'multi', hasVideo: false, price: '' },
  ...
  { sku: 'MX101',	name: 'Home On The Range', group: 'multi', hasVideo: false, price: '' },
  { sku: 'MX157',	name: 'Striker Serpent', group: 'multi', hasVideo: false, price: '' },
  ...
  { sku: 'NF107',	name: 'Green Wasp', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'NF112',	name: 'Ladybugs (60/3)', group: 'novelty', hasVideo: true, price: '' },
  { sku: 'NF210',	name: 'Jet Fighter Trio', group: 'novelty', hasVideo: true, price: '' },
  { sku: 'NF211',	name: 'Air Force Fleet', group: 'novelty', hasVideo: false, price: '' },
  ...
  { sku: 'NV123A', name: 'Booby Trap', group: 'novelty', hasVideo: false, price: '' },
  ...
  { sku: 'NV133',	name: 'Premium Ground Bloom Flower', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'NV161',	name: 'Sky Bacon Spinners', group: 'novelty', hasVideo: true, price: '' },
  { sku: 'NV180A', name: 'Fart Bags', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'NV182',	name: 'Stink Bombs', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'NV209A', name: 'Climbing Panda', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'NV293',	name: 'Normandy Landing Craft', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'NV316',	name: 'Spinning Firefly', group: 'novelty', hasVideo: false, price: '' },
  ...
  { sku: 'NV353',	name: 'Frog', group: 'novelty', hasVideo: false, price: '' },
  ...
  { sku: 'PC149',	name: 'Giant Parachute 40-inch', group: 'novelty', hasVideo: false, price: '' },
  ...
  { sku: 'RL114',	name: 'One-Inch Wonder', group: 'artillery', hasVideo: false, price: '' },
  { sku: 'RL133',	name: '6" Ring Master', group: 'artillery', hasVideo: true, price: '' },
  { sku: 'RL240A', name: '5" Hellcat Cans (60-gram Canisters)', group: 'artillery', hasVideo: false, price: '' },
  { sku: 'RL240B', name: '5" Hellcat Cans - 60-Gram Canister Shells', group: 'artillery', hasVideo: false, price: '' },
  { sku: 'RL292',	name: 'Close Combat', group: 'artillery', hasVideo: true, price: '' },
  { sku: 'RL335',	name: '24 Turbo Charged - 1.5" Canister Shells', group: 'artillery', hasVideo: false, price: '' },
  { sku: 'RL337',	name: 'Double Dragon - 6" Double-Break Canister', group: 'artillery', hasVideo: false, price: '' },
  { sku: 'RL350',	name: 'Titanium Willow Shells - 5" Canister', group: 'artillery', hasVideo: false, price: '' },
  { sku: 'RL360',	name: 'Festival Balls - 1.5" Ball Shells', group: 'artillery', hasVideo: true, price: '' },
  { sku: 'SK109',	name: 'Neon Smoke Balls Clay', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SK111',	name: 'Jumbo Color Smoke Balls', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SK115B', name: 'Color Military Smoke', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SK134',	name: 'Color Smoke Grenades', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SK143',	name: 'Worlds Largest Smoke Ball', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SK148',	name: 'Sword of Daylight', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SM104',	name: 'Jumbo Saturn Missiles', group: 'rocket', hasVideo: false, price: '' },
  { sku: 'SM128',	name: 'Flag Missile Battery', group: 'rocket', hasVideo: false, price: '' },
  { sku: 'SM150',	name: 'Saturn Missile Battery', group: 'rocket', hasVideo: false, price: '' },
  { sku: 'SM167',	name: 'Neon Saturn Missiles', group: 'rocket', hasVideo: false, price: '' },
  { sku: 'SN109',	name: 'Americas Best Snappers (RWB)', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SN115',	name: 'Bacon Snaps (Adult Snaps)', group: 'novelty', hasVideo: false, price: '' },
  ...
  { sku: 'SP116T', name: 'Morning Glory - 24in', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SP192',	name: 'Ten-Inch Sparklers (Wire)', group: 'novelty', hasVideo: false, price: '' },
  { sku: 'SR122',	name: 'Maximum Altitude - TX Legal', group: 'rocket', hasVideo: false, price: '' },
  { sku: 'SR216',	name: 'Skybolt - TX Legal', group: 'rocket', hasVideo: false, price: '' },
  { sku: 'SR224',	name: 'Giant Texas Pop Rocket - TX Legal', group: 'rocket', hasVideo: false, price: '' },
  { sku: 'TB211',	name: 'Addicted to Loud', group: 'multi', hasVideo: false, price: '' },
  { sku: 'TB215',	name: 'Khaotic KaBoom', group: 'multi', hasVideo: false, price: '' },
  { sku: 'TB237',	name: 'Whacky Tobacky', group: 'multi', hasVideo: false, price: '' },
  { sku: 'TB247',	name: 'Unstoppable', group: 'multi', hasVideo: false, price: '' },
